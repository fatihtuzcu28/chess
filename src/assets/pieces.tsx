...
/**
 * Modern, minimalist satranç taşı SVG'leri.
 * Her taş inline SVG olarak render edilir.
 */
...
export const WhiteKing: React.FC<{ size?: number }> = ({ size = 45 }) => (
  <svg width={size} height={size} viewBox="0 0 45 45" xmlns="http://www.w3.org/2000/svg">
    <g fill="none" fillRule="evenodd" stroke="#333" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
...
export const BlackKing: React.FC<{ size?: number }> = ({ size = 45 }) => (
  <svg width={size} height={size} viewBox="0 0 45 45" xmlns="http://www.w3.org/2000/svg">
    <g fill="none" fillRule="evenodd" stroke="#333" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
      ...
      <path d="M22.5 25s4.5-7.5 3-10.5c0 0-1-2.5-3-2.5s-3 2.5-3 2.5c-1.5 3 3 10.5 3 10.5" fill="#333" strokeLinecap="butt" strokeLinejoin="miter"/>
...
export const WhiteQueen: React.FC<{ size?: number }> = ({ size = 45 }) => (
  <svg width={size} height={size} viewBox="0 0 45 45" xmlns="http://www.w3.org/2000/svg">
    <g fill="#fff" stroke="#333" strokeWidth="1.5" strokeLinejoin="round">
...
export const BlackQueen: React.FC<{ size?: number }> = ({ size = 45 }) => (
  <svg width={size} height={size} viewBox="0 0 45 45" xmlns="http://www.w3.org/2000/svg">
    <g fill="#333" stroke="#333" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
      <path d="M8 12a2 2 0 1 1-4 0 2 2 0 1 1 4 0zM24.5 7.5a2 2 0 1 1-4 0 2 2 0 1 1 4 0zM41 12a2 2 0 1 1-4 0 2 2 0 1 1 4 0zM16 8.5a2 2 0 1 1-4 0 2 2 0 1 1 4 0zM33 9a2 2 0 1 1-4 0 2 2 0 1 1 4 0z"/>
...
export const WhiteRook: React.FC<{ size?: number }> = ({ size = 45 }) => (
  <svg width={size} height={size} viewBox="0 0 45 45" xmlns="http://www.w3.org/2000/svg">
    <g fill="#fff" stroke="#333" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
      ...
      <path d="M14 29.5H31M14 25H31M14 21H31" fill="none" strokeLinejoin="miter"/>
    </g>
  </svg>
);
...
export const WhitePawn: React.FC<{ size?: number }> = ({ size = 45 }) => (
  <svg width={size} height={size} viewBox="0 0 45 45" xmlns="http://www.w3.org/2000/svg">
    <path d="M22.5 9c-2.21 0-4 1.79-4 4 0 .89.29 1.71.78 2.38C17.33 16.5 16 18.59 16 21c0 2.03.94 3.84 2.41 5.03C15.41 27.09 11 31.58 11 39.5H34c0-7.92-4.41-12.41-7.41-13.47C28.06 24.84 29 23.03 29 21c0-2.41-1.33-4.5-3.28-5.62.49-.67.78-1.49.78-2.38 0-2.21-1.79-4-4-4z" fill="#fff" stroke="#333" strokeWidth="1.5" strokeLinecap="round"/>
  </svg>
);
...
export const BlackPawn: React.FC<{ size?: number }> = ({ size = 45 }) => (
  <svg width={size} height={size} viewBox="0 0 45 45" xmlns="http://www.w3.org/2000/svg">
    <path d="M22.5 9c-2.21 0-4 1.79-4 4 0 .89.29 1.71.78 2.38C17.33 16.5 16 18.59 16 21c0 2.03.94 3.84 2.41 5.03C15.41 27.09 11 31.58 11 39.5H34c0-7.92-4.41-12.41-7.41-13.47C28.06 24.84 29 23.03 29 21c0-2.41-1.33-4.5-3.28-5.62.49-.67.78-1.49.78-2.38 0-2.21-1.79-4-4-4z" fill="#333" stroke="#333" strokeWidth="1.5" strokeLinecap="round"/>
  </svg>
);

/** Taş tipine göre SVG componenti döndürür */
export const PieceMap: Record<string, React.FC<{ size?: number }>> = {
  wk: WhiteKing,
  wq: WhiteQueen,
  wr: WhiteRook,
  wb: WhiteBishop,
